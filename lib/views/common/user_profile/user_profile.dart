                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        // ---- NEW: Old / Current Password field ----
                        Padding(
                          padding: const EdgeInsets.only(left: 16, top: 10, right: 16),
                          child: TextFormField(
                            controller: viewModel.controllerOldPwd,
                            obscureText: viewModel.isObscureOpw,
                            decoration: InputDecoration(
                              labelText: 'Current Password',
                              prefixIcon: const Icon(Icons.lock_outline, color: Colors.black38),
                              suffixIcon: IconButton(
                                icon: Icon(
                                  viewModel.isObscureOpw ? Icons.visibility : Icons.visibility_off,
                                  color: Colors.black87,
                                ),
                                onPressed: () => viewModel.onIsObscureChangedToOpw(),
                              ),
                              filled: true,
                              fillColor: Colors.white,
                              enabledBorder: const UnderlineInputBorder(
                            ...
                            validator: (value) {
                              // Only required if the user is trying to set a new password
                              if (viewModel.controllerNewPwd.text.isNotEmpty ||
                                  viewModel.controllerConfirmPwd.text.isNotEmpty) {
                                if (value == null || value.isEmpty) {
