                ...
                children: [
                  ChangeNotifierProvider(
                    create: (_) => IncreaseDurationNotifier(
                      ...
                      double.parse(channel.flowRateLpH),
                      onTime: int.tryParse(channel.onTime) ?? 0,
                      offTime: int.tryParse(channel.offTime) ?? 0,
                      initialStatus: channel.status,
                    ),
                    child: Consumer<IncreaseDurationNotifier>(
                      builder: (context, durationNotifier, _) {
                        // Use timer status for icon
                        return Image.asset(AppConstants.getFertilizerChannelImage(
                            cIndex,
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      width: 60,
                      child: Center(
                        child: Text('${channel.flowRateLpH}-lph',
                          style: const TextStyle(
                            color: Colors.black,
                            fontSize: 9,
                            fontWeight: FontWeight.bold,
                      ...
                      child: ChangeNotifierProvider(
                        ...
                        child: Consumer<IncreaseDurationNotifier>(
                          builder: (context, durationNotifier, _) {
                            ...
                            return Center(
                              child: Text(
                                channel.frtMethod=='1' || channel.frtMethod=='3'?
